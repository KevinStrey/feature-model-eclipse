...
public class CollectorConfigDialog extends JDialog {
    ...
    public CollectorConfigDialog(List<String> orderedReleases,
        ...
        super((Frame) null, "EvoMetrics Collector — Configuração", true);
    ...
    private JPanel buildTitleBar() {
        ...
        JLabel title = new JLabel("⚙  EvoMetrics Collector");
        title.setFont(new Font("SansSerif", Font.BOLD, 20));
        title.setForeground(ACCENT);

        JLabel sub = new JLabel("Selecione as releases, features e configure a memória antes de iniciar a coleta");
    ...
    private JPanel buildButtonBar() {
        ...
        JButton start  = actionButton("  ▶  Iniciar Coleta  ", BTN_START);
